...
{
    public partial class Agregar_Inscripcion : Form
    {
        string fileName = "Inscripcion.txt";
        public Agregar_Inscripcion()
        {
            InitializeComponent();
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                sw.Write(txtFechaInscripcion.Text.Trim() + "|");
        ...
        private bool validate()
        {
            return String.IsNullOrEmpty(txtCentroEducativo.Text.Trim()) ||
             ...
             String.IsNullOrEmpty(txtFechaInscripcion.Text.Trim()) ||
